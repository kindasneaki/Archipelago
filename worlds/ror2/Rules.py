...
def has_entrance_access_rule(world, stage: str, entrance: str, player: int) -> None:
...
def has_location_access_rule(world, environment: str, player: int, item_number: int, item_type: str) -> None:
    if item_number == 1:
...
def get_stage_event(world, player: int, stage_number: int) -> None:
...
def get_one_of_the_stages(state: "CollectionState", stage: str, player: int) -> bool:
